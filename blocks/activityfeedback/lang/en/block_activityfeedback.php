...
$string['opt2activeadmin'] = 'active (option 2)';
$string['opt2nameadmin'] = 'name (option 2)';
$string['opt2pictureadmin'] = 'picture (option 2)';
$string['opt3activeadmin'] = 'active (option 3)';
$string['opt3nameadmin'] = 'name (option 3)';
$string['opt3pictureadmin'] = 'picture (option 3)';
$string['opt4activeadmin'] = 'active (option 4)';
$string['opt4nameadmin'] = 'name (option 4)';
$string['opt4pictureadmin'] = 'picture (option 4)';
$string['opt5activeadmin'] = 'active (option 5)';
$string['opt5nameadmin'] = 'name (option 5)';
$string['opt5pictureadmin'] = 'picture (option 5)';
$string['opt6activeadmin'] = 'active (option 6)';
$string['opt6nameadmin'] = 'name (option 6)';
$string['opt6pictureadmin'] = 'picture (option 6)';
